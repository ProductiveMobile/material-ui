...
var Tabs = React.createClass({
  ...
  render: function render() {
    ...
    var content = [React.createElement(
      'div',
      { style: this.mergeAndPrefix(styles.tabItemContainer, tabItemContainerStyle), key: 'tabs' },
      tabs
    ), React.createElement(
      'div',
      { style: { width: inkBarContainerWidth }, key: 'ink-bar' },
      inkBar
    ), React.createElement(
      'div',
      { style: this.mergeAndPrefix(contentContainerStyle), key: 'content' },
      tabContent
    )];
    ...
    return React.createElement(
      'div',
      _extends({}, other, { style: this.mergeAndPrefix(style) }),
      content
    );
  },
