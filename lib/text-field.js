...
var TextField = React.createClass({
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['className', 'errorStyle', 'errorText', 'underlineStyle', 'hintStyle', 'floatingLabelText', 'fullWidth', 'hintText', 'id', 'multiLine', 'onBlur', 'onChange', 'onFocus', 'type', 'rows']);
    ...
    var underlineElement = this.props.disabled ? React.createElement('div', {
      style: this.mergeAndPrefix(styles.underlineAfter, underlineStyle) }) : React.createElement('hr', {
      style: this.mergeAndPrefix(styles.underline, underlineStyle) });
    var focusUnderlineElement = React.createElement('hr', {
